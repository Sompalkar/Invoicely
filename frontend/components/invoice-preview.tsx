...
export function InvoicePreview({
  ...
  const clientData =
    clientMode === "existing" ? selectedClientData : tempClient;
  ...
  return (
    <Card>
      <CardContent className="p-6">
        <div
          ref={invoiceRef}
          className="border rounded-lg p-8 bg-background shadow-sm"
        >
            ...
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Please make payment by the due date to the account details
                  provided.
                </p>
      ...
      <CardFooter className="flex justify-end space-x-2">
        ...
        <PdfGenerator
          ...
          fileName={`Invoice-${Date.now().toString().slice(-6)}`}
        />
        <Button
          variant="default"
